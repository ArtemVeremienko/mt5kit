"""
MetaTrader 5 Data Interface for Macro Market Regime Analysis.
"""
...
def get_symbol_info(symbol: str) -> Optional[SymbolInfo]:
    ...
    if "XAU" in sym_upper or "GOLD" in sym_upper:
        ...
        pip_size = 0.01 # $0.01 for Silver
    elif "BTC" in sym_upper:
        pip_size = 1.0  # $1.00 for BTC
    elif "BRENT" in sym_upper or "WTI" in sym_upper or "OIL" in sym_upper:
        pip_size = 0.01 # $0.01 for Oil
    elif any(idx in sym_upper for idx in ["US500", "SPX", "USTECH", "NAS", "DE40", "GER", "JP225", "WS30", "DJI"]):
        # CFD Indices
        if digits == 1:
            pip_size = 0.1
        elif digits == 2:
            ...
            pip_size = point * 10 if point > 0 else 1.0
    elif digits in (3, 5):
        pip_size = point * 10
    elif digits in (2, 4):
        pip_size = point
