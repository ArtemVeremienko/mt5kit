    ...
    with open(csv_path, "w", newline="", encoding="utf-8") as f:
        ...
        for m in sorted(metrics_list, key=lambda x: x.symbol):
            writer.writerow({
                ...
                "p99_spread": round(getattr(m, "p99_spread", m.p95_spread), 4),
                "p999_spread": round(getattr(m, "p999_spread", m.max_spread), 4),
                ...
                "tail_blowout_ratio": round(getattr(m, "tail_blowout_ratio", 1.0), 4),
                "max_to_median_ratio": round(getattr(m, "max_to_median_ratio", 1.0), 4),
                ...
                "core_max_quote_gap_sec": round(getattr(m, "core_max_quote_gap_sec", 0.0), 4),
