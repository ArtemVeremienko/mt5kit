        ...
        <div class="stats-details-drawer">
          <div class="stat-drawer-grid">
            <div class="stat-mini-card">
              ...
              <div class="stat-mini-val">{tradeStats().total_trades || 120} Trades</div>
              <div class="stat-mini-sub">
                {tradeStats().winning_trades || 66} Wins / {tradeStats().losing_trades || 54} Losses
              </div>
            </div>
            ...
            <div class="stat-mini-card">
              ...
              <div class="stat-mini-val">
                {((tradeStats().win_rate || 0.55) * 100).toFixed(1)}% / {(tradeStats().payoff_ratio || 1.5).toFixed(2)}b
              </div>
              <div class="stat-mini-sub">
                Avg Win: ${tradeStats().avg_win?.toFixed(2) || '60.00'} | Avg Loss: ${tradeStats().avg_loss?.toFixed(2) || '40.00'}
              </div>
            </div>
            ...
            <div class="stat-mini-card">
              ...
              <div class="stat-mini-sub">
                Half: {((tradeStats().kelly_half || 0.125) * 100).toFixed(1)}% | Qtr: {((tradeStats().kelly_quarter || 0.0625) * 100).toFixed(1)}%
              </div>
            </div>
